...
# GO_SOURCE = go1.11.13.linux-arm64.tar.gz
#
...
TARGET_GOLANG_ENV = PATH=$(TARGET_PATH) \
		  GOARCH= \
		  GOBIN= \
		  GOEXE= \
		  GOPATH="$(BUILD_DIR)/go_pkgs" \
...
define TARGET_GOLANG_BUILD_CMDS
	...
	./make.bash
endef
define TARGET_GOLANG_INSTALL_CMDS
	$(INSTALL) -d -m 0755 "$(GOLANG_GOROOT)"
	cp -a "$(@D)"/* "$(GOLANG_GOROOT)/"
	ln -sfT "../lib/golang/bin/go" "$(TARGET_DIR)/usr/bin/go"
	ln -sfT "../lib/golang/bin/gofmt" "$(TARGET_DIR)/usr/bin/gofmt"
endef
define TARGET_GOLANG_CLEAN_CMDS
