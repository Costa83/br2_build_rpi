...
SQLITE lib and executable va etre installé dans le répertoire host et target de output/ grace à l’outil libtool.
...
0 – Copie de libsqlite3.so.0.8.6 
             libsqlite3.so.0
		 libsqlite3.so
