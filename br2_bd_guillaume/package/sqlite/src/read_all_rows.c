...
/*Programme qui effectue une requête "SQL READ * from STT;" de lecture de toutes les lignes dans la base test_sqlite.db, et mesure des performances de lecture de ces lignes*/
